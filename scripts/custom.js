...
$(document).ready(function(){
	...
	var t1 = new Date('2016-10-28T00:00:00');	
				
	setInterval(function() {
				var t2 = new Date();
				var diff1 = t1.getTime() - t2.getTime();
				var diff2 = t2.getTime() - t1.getTime();
				var hours = diff2 * 2.7778e-7+' ';
				var minutes = diff2 * 1.6667e-5+' ';
				var secondes = diff2 * 0.001+' ';
				var strHours = hours.split('.')[0];
				var strMinutes = minutes.split('.')[0];
				var strSeconds = secondes.split('.')[0];
				var hour = strHours + "h " + t2.getMinutes() + "mn " + t2.getSeconds()+"s";
				$('.counter2').text(hour);
			}, 1000);
